...
- **Review** — the `wishes` blueprint is entirely read-only in the Control
  Panel, split into Wunsch / Kontaktdaten / Einwilligungen. An entry is a record
  of what somebody sent, not an editable document.
