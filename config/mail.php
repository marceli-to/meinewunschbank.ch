...
return [
	...
	*/
	...
	|--------------------------------------------------------------------------
	|
	| Where the "a new wish was submitted" notification goes. Outside production
	| the catch-all above still wins, so this never leaves the dev machine.
	|
	*/

	'notify' => env('MAIL_NOTIFY'),
